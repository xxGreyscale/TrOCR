...
python model_evaluation.py --name base-scratch-model --batch_size 128 --dataset_name synthetic --dataset /home/x_salom/TrOCR/datasets/printed/synthetic/test/image_labels_dataset.csv --model custom_models/duplicated-3/trocr-printed/scratch/base/1.3/vision_model --processor custom_models/duplicated-3/trocr-printed/scratch/base/1.3/processor
python model_evaluation.py --name base-scratch-model --batch_size 128 --dataset_name kubhist --dataset /home/x_salom/TrOCR/datasets/printed/Histrorical_News_Paper/test.csv  --model custom_models/duplicated-3/trocr-printed/scratch/base/1.3/vision_model --processor custom_models/duplicated-3/trocr-printed/scratch/base/1.3/processor