...
python main.py --train --custom --dataset_paths datasets/printed/synthetic/110k/image_labels_dataset.csv datasets/printed/synthetic/130k/image_labels_dataset.csv --save_dir custom_models/trocr-printed/scratch/medium --config_path configs/train/trOCR/printed/custom_printed.json