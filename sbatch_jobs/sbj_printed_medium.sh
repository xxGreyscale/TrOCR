...
python main.py --train --pretrained --dataset_paths datasets/printed/synthetic/110k/image_labels_dataset.csv datasets/printed/synthetic/130k/image_labels_dataset.csv  --save_dir custom_models/trocr-printed/new/medium --train_config_path configs/train/trOCR/printed/custom_printed.json
