...
python main.py --train --pretrained --dataset_paths datasets/printed/synthetic/130k/image_labels_dataset.csv --save_dir custom_models/trocr-printed/pretrained/small --train_config_path configs/train/trOCR/printed/custom_pretrained_htr_small.json
