...
python main.py --train --pretrained --dataset_paths datasets/printed/synthetic/beta_v2/image_labels_dataset.csv --save_dir custom_models/trocr-printed/pretrained/small --config_path configs/train/trOCR/printed/custom_pretrained_htr_small.json
